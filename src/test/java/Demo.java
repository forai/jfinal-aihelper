...
//        ISqlBuilder sqlBuilder = new OracleBuilder();
        ...
        p2.start();
        SqlParam sp = SqlParam.create(new ParamMap().put("age",17).put("addr","北京路").put("time",new Date()).put("add_ids","3,4,5").put("type_ids",new String[]{"1","3"}).put("user_ids",new Integer[]{2,3,4}));
        ...
        sp.in("add_id","add_ids").in("type_id","type_ids").in("user_id","user_ids");
